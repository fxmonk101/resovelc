...
export function StatsBar() {
  return (
    <section className="bg-ivory py-16 border-y border-border">
      <div className="container-page grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-4 md:divide-x md:divide-border">
        ...
        <div className="text-center">
          <div className="font-mono text-3xl md:text-4xl font-medium text-slate-deep">251480576</div>
          <div className="text-label text-slate-light mt-2">Routing #</div>
        </div>
