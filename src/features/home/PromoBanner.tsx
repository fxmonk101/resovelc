    ...
    <section className="bg-ivory-dark py-24">
      <div className="container-page grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold mt-5 text-slate-deep">
          ...
          <p className="text-xs text-slate-light mt-4">*Demo offer. Terms apply. Not a real promotion.</p>
        </div>
      </div>
    </section>
  );
